/*-------------------------------------------------------------------------
Animator provides animation timing support.
...
#define ANIM_MILLISECONDS        1    // ~65 seconds max duration, ms updates
#define ANIM_CENTISECONDS       10    // ~10.9 minutes max duration, centisecond updates
#define ANIM_DECISECONDS       100    // ~1.8 hours max duration, decisecond updates
#define ANIM_SECONDS          1000    // ~18.2 hours max duration, second updates
#define ANIM_DECASECONDS     10000    // ~7.5 days, 10 second updates
...
public:
  ...
  Animator(uint16_t countAnimations, uint16_t timeScale = ANIM_MILLISECONDS) :
  ...
  bool NextAvailableAnimation(uint16_t* indexAvailable, uint16_t indexStart)
  {
