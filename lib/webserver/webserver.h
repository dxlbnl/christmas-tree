...
public:
        ...
        , main(main)
    {
        ...
        handler = new AsyncCallbackJsonWebHandler("/color", [main](AsyncWebServerRequest *request, JsonVariant &json) {
          JsonObject jsonObj = json.as<JsonObject>();

          main->current()->setConfig(jsonObj);
